...
2. **What is superpowers?**
   - A collection of AI skills covering the different stages of the SDLC

3. **What is a skill? — concept** (~1.5 min)
   - Definition: a folder of instructions an agent pulls in when relevant, to perform a particular task
...
4. **What is a skill? — how it works** (~2 min)
...
5. **Open standard, quickly** (~1.5 min)
...
7. **The skill map** (~2 min) — anchor visual
...
8. **Brainstorming: ceremony scales to the task** (~1.5 min)
...
10. **From brainstorm to spec** (~1 min) — real artifact
...
11. **Plans → subagent-driven development** (~1.5 min) — real artifact
...
13. **What to watch out for** (~1.5 min)
    - Model choice matters (less powerful models need more guidance during development).
